...
@interface MegSystemViewController ()<UITableViewDelegate, UITableViewDataSource>


@end

@implementation MegSystemViewController
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView{
    return [MessageData singleInstance].system.count;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setID:[MessageData singleInstance].system[indexPath.section][@"Data"][@"ID"]
         Avatar:[MessageData singleInstance].system[indexPath.section][@"User"][@"Avatar"]
           Name:@"系统通知"
        Content:[MessageData singleInstance].system[indexPath.section][@"Data"][@"Content"]
