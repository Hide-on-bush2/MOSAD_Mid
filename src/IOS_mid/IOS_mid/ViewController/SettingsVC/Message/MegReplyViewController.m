...
@interface MegReplyViewController ()<UITableViewDelegate, UITableViewDataSource>


@end

@implementation MegReplyViewController
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView{
    return [MessageData singleInstance].reply.count;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setID:[MessageData singleInstance].reply[indexPath.section][@"Data"][@"ID"]
         Avatar:[MessageData singleInstance].reply[indexPath.section][@"User"][@"Avatar"]
           Name:[MessageData singleInstance].reply[indexPath.section][@"User"][@"Name"]
        Content:[@"评论了你：" stringByAppendingString:[MessageData singleInstance].reply[indexPath.section][@"Data"][@"Content"]]
           time:[MessageData singleInstance].reply[indexPath.section][@"Data"][@"CreateTime"]
           Read:[MessageData singleInstance].reply[indexPath.section][@"Data"][@"Read"]];
    return cell;
}
