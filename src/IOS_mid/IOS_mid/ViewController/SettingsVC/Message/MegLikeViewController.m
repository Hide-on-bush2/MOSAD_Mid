...
@interface MegLikeViewController ()<UITableViewDelegate, UITableViewDataSource>


@end

@implementation MegLikeViewController
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView{
    return [MessageData singleInstance].like.count;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setID:[MessageData singleInstance].like[indexPath.section][@"Data"][@"ID"]
         Avatar:[MessageData singleInstance].like[indexPath.section][@"User"][@"Avatar"]
           Name:[MessageData singleInstance].like[indexPath.section][@"User"][@"Name"]
        Content:@"点赞了你的内容"
           time:[MessageData singleInstance].like[indexPath.section][@"Data"][@"CreateTime"]
           Read:[MessageData singleInstance].like[indexPath.section][@"Data"][@"Read"]];
    return cell;
}
