...
//  IOS_mid
//
//  Created by jinshlin on 2020/12/1.
...
@interface AddAlbumVC ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
